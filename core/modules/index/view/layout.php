    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">RESTAURANT <sup><small><span class="label label-info">v1.0</span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          ...
          <li><a href="index.php?view=users"><i class="glyphicon glyphicon-user"></i> Usuarios </a></li>
          <li><a href="index.php?view=clientes"><i class="fa fa-users"></i> Clientes </a></li>
